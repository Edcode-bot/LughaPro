...
export function BookingPanel({ hourlyRate, tutorId, tutorName = "your tutor", availability = [] }: BookingPanelProps) {
  ...
  return (
    <div className="sticky top-24 rounded-3xl border border-forest/10 bg-white p-5 shadow-sm max-lg:static">
