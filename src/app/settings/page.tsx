        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[260px_1fr]">
            ...
            <section className="grid gap-6">
              ...
              <section id="security"><Card><h2 className="font-serif text-3xl font-black">Security</h2><p className="mt-3 text-forest/65">Wallet-only authentication is enabled.</p><Button className="mt-4" variant="secondary">Disconnect Wallet</Button></Card></section>
